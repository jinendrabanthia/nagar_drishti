      ...
      <main className="flex-1 flex flex-col lg:flex-row items-center justify-center px-6 py-12 lg:py-16 gap-12 lg:gap-20 max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="flex-1 space-y-10 max-w-2xl">
          <div className="space-y-6">
            <div className="inline-flex items-center gap-2 glass-card px-5 py-2.5 rounded-full text-sm shadow-sm border border-teal-100 bg-white/80">
        ...
        <div className="w-full max-w-md relative mt-8 lg:mt-0">
          ...
          <div className="relative glass-card rounded-[2rem] overflow-hidden border border-white/60 shadow-xl bg-white/80 backdrop-blur-xl">
